                ...
                <div class="widget widget-account-invoice-three">
                    ...
                    <div class="widget-heading">
                        <div class="wallet-usr-info">
                            ...
                            <div class="add">
                                <span><a href="deposit.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus text-white">
                    ...
                    <div class="widget-amount">
                        ...
                        <div class="w-a-info funds-received">
                            <span>Deposit <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down">
                        ...
                        <div class="w-a-info funds-spent">
                            <span>Transfer <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-up">
...
";
                                ...
                                <div class="info-detail-2">
                                    <p>Last Login IP:</p>
                                    <p class=""><span class="bill-amount text-dark"><?= $logs['ipAddress'] ?> </span></p>
                                </div>

                                <div class="info-detail-2">
                                    <p>Last Login Date:</p>
                                    <p class=""><span class="bill-amount text-dark"><?= $logs['datenow'] ?> </span></p>
                                </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="th-content th-heading">TYPE</div>
                                        </th>
                                        <th>
                                            <div class="th-content">SENDER / RECEIVER</div>
                                        </th>
                                        <th>
                                        ...
                                        <th>
                                            <div class="th-content th-heading">TIME CREATED</div>
                                        </th>
                                        <th>
                                            ...
                                            <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="input-group ">
                                                    <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="<?= $deposit['bank_name'] ?>" value="<?= $deposit['bank_name'] ?>"
                                                        ...
                                                        readonly>
                                                    <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#bank_name"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy">
                                            ...
                                            <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="input-group ">
                                                    <input type="text" class="form-control" name="acct_no" id="acct_no" placeholder="<?= $deposit['acct_no'] ?>" value="<?= $deposit['acct_no'] ?>"
                                                        aria-label="notification" aria-describedby="basic-addon1"
                                                        readonly>
                                                    <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#acct_no"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy">
                                                            <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                                            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                                        </svg> Copy</a>
                                                </div>
                                            ...
                                            <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="input-group ">
                                                    <input type="text" class="form-control" name="routine_no" id="routine_no" placeholder="<?= $deposit['routine_no'] ?>" value="<?= $deposit['routine_no'] ?>"
                                                        aria-label="notification" aria-describedby="basic-addon1"
                                                        readonly>
                                                    <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#routine_no"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy">
                                                            <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                                            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                                        </svg> Copy</a>
                                                </div>
                                            ...
                                            <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="input-group ">
                                                    <input type="text" class="form-control" name="swift_code" id="swift_code" placeholder="<?= $deposit['swift_code'] ?>" value="<?= $deposit['swift_code'] ?>"
                                                        aria-label="notification" aria-describedby="basic-addon1"
                                                        readonly>
                                                    <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#swift_code"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy">
                                                            <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                                                            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                                                        </svg> Copy</a>
                                                </div>
